...
const translations = {
	'zh-CN': {
		...
		footer: {
			...
			version: "当前版本：<strong>2.0.2.2-20251220</strong>"
		},
		settings: {
			title: "设置",
			...
			particleAnimation: { title: "粒子动画", subtitle: "在页面上显示粒子动画", options: ["关闭","樱花","落叶梧桐","落叶银杏","雪花"] }
		},
		buttons: {
			scrollToTop: "返回顶部"
		},
	...
	'zh-TW': {
		...
		header: {
			homeLink: "主頁", searchBtn: "搜尋", themeToggleBtn: "切換深色/淺色模式", themeSettingsBtn: "設定", languageSelectorBtn: "選擇語言", avatarAlt: "頭像"
		},
		...
		footer: { copyright: "&copy; 2022-2025 whwdzg. 保留所有權利。", version: "當前版本：<strong>2.0.2.2-20251220</strong>" },
		lightbox: { close: "關閉圖片", zoomIn: "放大", zoomOut: "縮小", download: "下載圖片", locate: "定位到原文", prev: "上一張", next: "下一張", fullscreen: "全螢幕", exitFullscreen: "退出全螢幕", zoomInputPlaceholder: "40-400%", zoomInputLabel: "縮放百分比" },
		settings: {
			title: "設定",
			...
			particleAnimation: { title: "粒子動畫", subtitle: "在頁面上顯示粒子動畫", options: ["關閉","櫻花","落葉梧桐","落葉銀杏","雪花"] }
		},
	...
	'ru-RU': {
		...
		footer: { copyright: "&copy; 2022-2025 whwdzg. Все права защищены.", version: "Текущая версия: <strong>2.0.2.2-20251220</strong>" },
		lightbox: { close: "Закрыть изображение", zoomIn: "Увеличить", zoomOut: "Уменьшить", download: "Скачать изображение", locate: "Найти в документе", prev: "Предыдущее", next: "Следующее", fullscreen: "На весь экран", exitFullscreen: "Выйти из полноэкранного", zoomInputPlaceholder: "40-400%", zoomInputLabel: "Процент масштабирования" },
		settings: {
			title: "Настройки",
			...
			particleAnimation: { title: "Анимация частиц", subtitle: "Отображать анимацию частиц на странице", options: ["Отключено","Сакура","Листья платана","Листья гинкго","Снег"] }
		},
	...
	'fr-FR': {
		...
		footer: { copyright: "&copy; 2022-2025 whwdzg. Tous droits réservés.", version: "Version actuelle : <strong>2.0.2.2-20251220</strong>" },
		lightbox: { close: "Fermer l'image", zoomIn: "Agrandir", zoomOut: "Réduire", download: "Télécharger l'image", locate: "Aller au texte", prev: "Précédent", next: "Suivant", fullscreen: "Plein écran", exitFullscreen: "Quitter le plein écran", zoomInputPlaceholder: "40-400%", zoomInputLabel: "Pourcentage de zoom" },
		settings: {
			title: "Paramètres",
			...
			particleAnimation: { title: "Animation de particules", subtitle: "Afficher une animation de particules sur la page", options: ["Désactivé","Sakura","Feuilles de platane","Feuilles de ginkgo","Neige"] }
		},
	...
	'de-DE': {
		...
		footer: { copyright: "&copy; 2022-2025 whwdzg. Alle Rechte vorbehalten.", version: "Aktuelle Version: <strong>2.0.2.2-20251220</strong>" },
	...
	'ja-JP': {
		...
		header: { homeLink: "ホーム", searchBtn: "検索", themeToggleBtn: "ダーク/ライト切替", themeSettingsBtn: "設定", languageSelectorBtn: "言語を選択", avatarAlt: "アバター" },
		avatar: { github: "GitHub", bilibili: "bilibili" },
		...
		footer: { copyright: "&copy; 2022-2025 whwdzg. All rights reserved.", version: "現在のバージョン：<strong>2.0.2.2-20251220</strong>" },
		lightbox: { close: "画像を閉じる", zoomIn: "拡大", zoomOut: "縮小", download: "画像をダウンロード", locate: "本文へ移動", prev: "前へ", next: "次へ", fullscreen: "全画面表示", exitFullscreen: "全画面終了", zoomInputPlaceholder: "40-400%", zoomInputLabel: "拡大率" },
		settings: {
			title: "設定",
			...
			particleAnimation: { title: "パーティクルアニメーション", subtitle: "ページ上にパーティクルアニメーションを表示", options: ["オフ","桜","プラタナスの葉","イチョウの葉","雪"] }
		},
	...
	'en-US': {
		...
		footer: {
			...
			version: "Current version: <strong>2.0.2.2-20251220</strong>"
		},
		settings: {
			title: "Settings",
			...
			particleAnimation: { title: "Particle animation", subtitle: "Show particle animation on the page", options: ["Off","Sakura","Plane tree leaves","Ginkgo leaves","Snow"] }
		},
		buttons: {
