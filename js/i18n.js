...
const translations = {
	'zh-CN': {
		...
		main: {
			aboutTitle: "关于",
			aboutContent: "这里是2.0版本的主页，当前正在构建中，尚处于<strong>极早期阶段</strong>，供实验学习使用",
			testTitle: "test"
		},
		aside: {
			noticeTitle: "注意",
	...
	'en-US': {
		...
		main: {
			aboutTitle: "About",
			aboutContent: "This is the home page of version 2.0, currently under construction and in <strong>very early stages</strong>, for experimental learning purposes",
			testTitle: "test"
		},
		aside: {
			noticeTitle: "Notice",
