...
document.addEventListener('DOMContentLoaded', function () {
	...
	const LANGUAGE_KEY = 'language';
		const FALLBACK_LOCALE = { page: { title: '主页', aboutTitle: '关于' }, header: {}, avatar: {}, sidebar: {}, buttons: {}, main: {}, aside: {}, footer: { version: '当前版本：<strong>2.0.2.6-20260117</strong>' }, theme: {}, language: {} };
